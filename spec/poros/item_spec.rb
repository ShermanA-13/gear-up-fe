...
describe "Item poro" do
  before do
    ...
    item_1_attr = {id: 1, type: "item", attributes: {name: "Item 1", description: "1st Item Description", count: 1, category: "Tent", user_id: @user_1.id }}
    @item_1 = Item.new(item_1_attr)

    item_2_attr = {id: 2, type: "item", attributes: {name: "Item 2", description: "2nd Item Description", count: 1, category: "Food", user_id: @user_1.id }}
