class Weather
  attr_reader :date, :low_temp, :high_temp, :cloud_coverage, :feels_like, :humidity, :percipitation_probability, :visibility, :weather, :weather_description, :weather_icon, :wind_direction, :wind_gust, :wind_speed
